    ...
    <div class="md-layout md-gutter md-alignment-top-center">
      <div class="md-layout-item md-large-size-80 md-xlarge-size-80 md-medium-size-90 md-small-size-100">
        ...
        <ul>
          ...
          <li>
            <b>#тег</b> - поле использвется только в статистике, помечая задачи тем или иным тегом можно будет увидеть,
        ...
        <p>
          Таким образом, корректные примеры указания задач могут выглядеть слудеющим образом:<br>
          <ul>
